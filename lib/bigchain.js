...
const seed2 = bip39.mnemonicToSeedSync("consumptionlocation").slice(0, 32);

const haitran = new BigchainDB.Ed25519Keypair(seed);
const consumptionLocation = new BigchainDB.Ed25519Keypair(seed2);

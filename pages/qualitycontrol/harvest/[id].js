            ...
            >
                ...
                <List spacing={4}>
                  ...
                  <ListItem>
                    <Text fontSize="md" fontWeight="bold">
                      Mật độ thả:{" "}
                      <Box as="span" fontWeight="normal">
                        {data.pond.seed.stockingDensity}
                      </Box>
                    </Text>
                  </ListItem>
                  <ListItem>
              ...
              >
                <Collapse ghost>
                  ...
                  {/* Start ReplaceWater */}
                  <Panel header="Thay nước" key="5">
                    <Table>
                      <Tr>
                        <Th>#</Th>
                        <Th>Ngày ghi</Th>
                        <Th>Lượng nước được thay</Th>
                      </Tr>
                      {data.replaceWater.map(
                        ({ createdDate, percentage }, i) => (
                          <Tr cursor="pointer">
                            <Td>{i + 1}</Td>
                            <Td>{createdDate}</Td>
                            <Td>{percentage} %</Td>
